<template>
  ...
  >
    <div :class="cn('-z-30 blur-[2px] pointer-events-none', 'absolute inset-0 overflow-visible [container-type:size]')">
      <div
    ...
    <span class="relative z-10 text-white"><slot /></span>
    ...
    <div
      class="absolute -z-20 pointer-events-none [background:var(--bg)] [border-radius:var(--radius)] [inset:var(--cut)]"
    />
  </button>
</template>
